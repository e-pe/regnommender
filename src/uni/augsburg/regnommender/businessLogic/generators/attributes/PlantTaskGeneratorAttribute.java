 ...
 */
public class PlantTaskGeneratorAttribute extends TaskGeneratorAttribute{
	 ...
	 * @param attribute
	 */
	public PlantTaskGeneratorAttribute(IThreshold threshold, ITaskAttributeSourceType<?> sourceType) {
