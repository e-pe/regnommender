 ...
 */
public class CuttingTaskGeneratorAttribute extends TaskGeneratorAttribute{
	 ...
	 * @param attribute
	 */
	public CuttingTaskGeneratorAttribute(IThreshold threshold, ITaskAttributeSourceType<?> sourceType) {
	...
	{		
		//db request
		double value=(Float)this.sourceType.getSource().getValue();
