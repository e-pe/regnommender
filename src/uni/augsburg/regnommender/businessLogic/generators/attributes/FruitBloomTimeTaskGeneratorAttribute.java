 ...
 *
 */
public class FruitBloomTimeTaskGeneratorAttribute extends TaskGeneratorAttribute{
	

	public FruitBloomTimeTaskGeneratorAttribute(IThreshold threshold, ITaskAttributeSourceType<?> sourceType) {
